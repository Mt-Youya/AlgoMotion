    ...
    >
      {lines.map((line, i) => {
        ...
        return (
          ...
          >
            <span style={{ color: P.gray, userSelect: "none", minWidth: 28, textAlign: "right" }}>{lineNum}</span>
            <span>{line}</span>
          </div>
        )
      })}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <span style={{ fontSize: 22, color: P.gray, fontWeight: 500 }}>/{String(total).padStart(2, "0")}</span>
      </span>
    </div>
  )
}
